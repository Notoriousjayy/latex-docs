...
\newcommand{\ChapterMark}{Chapter 60}
\title{\textcolor{Navy}{Chapter 60: Identity Theft}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 60: Identity Theft - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={identity, theft, phishing, and access}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
