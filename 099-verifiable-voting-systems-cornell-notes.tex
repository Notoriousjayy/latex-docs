...
\newcommand{\ChapterMark}{Chapter 99}
\title{\textcolor{Navy}{Chapter 99: Verifiable Voting Systems}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 99: Verifiable Voting Systems - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={voter, voting, ballot, and schemes}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
