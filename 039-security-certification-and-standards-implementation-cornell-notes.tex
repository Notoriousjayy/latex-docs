...
\newcommand{\ChapterMark}{Chapter 39}
\title{\textcolor{Navy}{Chapter 39: Security Certification and Standards Implementation}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 39: Security Certification and Standards Implementation - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={audit, controls, process, and support}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
