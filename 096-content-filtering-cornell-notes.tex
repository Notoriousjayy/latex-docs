...
\newcommand{\ChapterMark}{Chapter 96}
\title{\textcolor{Navy}{Chapter 96: Content Filtering}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 96: Content Filtering - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={internet, content, proxy, and filtering}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
