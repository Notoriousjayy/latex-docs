...
\newcommand{\ChapterMark}{Chapter 34}
\title{\textcolor{Navy}{Chapter 34: Security Education, Training, and Awareness}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 34: Security Education, Training, and Awareness - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={program, training, seta, and organization}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
