...
\title{\textcolor{Navy}{Chapter 11: UNIX and Linux Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 11: UNIX and Linux Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={user, unix, access, and file}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
