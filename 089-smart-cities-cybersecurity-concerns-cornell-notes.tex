...
\newcommand{\ChapterMark}{Chapter 89}
\title{\textcolor{Navy}{Chapter 89: Smart Cities: Cybersecurity Concerns}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 89: Smart Cities: Cybersecurity Concerns - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={smart, cities, city, and cybersecurity}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
