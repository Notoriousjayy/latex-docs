...
\newcommand{\ChapterMark}{Chapter 27}
\title{\textcolor{Navy}{Chapter 27: Information Technology Security Management}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 27: Information Technology Security Management - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={cybersecurity, organization, risk, and teams}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
