...
\begin{tikzpicture}[
    ...
    % Central system
    \node[draw, thick, fill=cnccolor!30, minimum width=4cm, minimum height=1.5cm, rounded corners=5pt] (system) at (0,-3.5) {\textbf{Complete Architecture}\\Documentation Package};
...
\begin{tikzpicture}[
    ...
    gateway/.style={draw, thick, fill=alloccolor!30, minimum width=3cm, minimum height=1cm, rounded corners=3pt, font=\small},
    db/.style={draw, thick, fill=datacolor!40, cylinder, shape border rotate=90, minimum width=1.2cm, minimum height=0.8cm, font=\scriptsize},
    external/.style={draw, thick, dashed, fill=externalcolor!20, minimum width=2cm, minimum height=0.8cm, rounded corners=3pt, font=\scriptsize},
    arrow/.style={-{Stealth[length=2mm]}, thick}
]
    % API Gateway
...
\begin{tikzpicture}[
    ...
    db/.style={draw, thick, fill=datacolor!30, cylinder, shape border rotate=90, minimum width=1.5cm, minimum height=1cm, font=\scriptsize}
]
    % AWS Cloud boundary
