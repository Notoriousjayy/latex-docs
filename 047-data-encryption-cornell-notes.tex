...
\newcommand{\ChapterMark}{Chapter 47}
\title{\textcolor{Navy}{Chapter 47: Data Encryption}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 47: Data Encryption - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={message, mod, key, and group}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
