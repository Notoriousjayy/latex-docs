...
\newcommand{\ChapterMark}{Chapter 68}
\title{\textcolor{Navy}{Chapter 68: Virtual Private Cloud Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 68: Virtual Private Cloud Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={cloud, vpc, private, and service}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
