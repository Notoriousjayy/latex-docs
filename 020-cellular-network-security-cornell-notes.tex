...
\newcommand{\ChapterMark}{Chapter 20}
\title{\textcolor{Navy}{Chapter 20: Cellular Network Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 20: Cellular Network Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={service, attack, cellular, and nodes}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
