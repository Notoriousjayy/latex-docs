...
\newcommand{\ChapterMark}{Chapter 61}
\title{\textcolor{Navy}{Chapter 61: VoIP Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 61: VoIP Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={sip, attacker, voip, and proxy}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
