...
\newcommand{\ChapterMark}{Chapter 67}
\title{\textcolor{Navy}{Chapter 67: Private Cloud Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 67: Private Cloud Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={cloud, service, private, and support}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
