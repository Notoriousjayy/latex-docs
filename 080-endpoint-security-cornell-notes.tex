...
\newcommand{\ChapterMark}{Chapter 80}
\title{\textcolor{Navy}{Chapter 80: Endpoint Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 80: Endpoint Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={eps, protection, company, and endpoint}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
