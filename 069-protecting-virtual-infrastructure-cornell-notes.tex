...
\newcommand{\ChapterMark}{Chapter 69}
\title{\textcolor{Navy}{Chapter 69: Protecting Virtual Infrastructure}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 69: Protecting Virtual Infrastructure - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={virtual, hypervisor, hardware, and software}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
