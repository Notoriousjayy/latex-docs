...
\newcommand{\ChapterMark}{Chapter 66}
\title{\textcolor{Navy}{Chapter 66: Cloud Security Trends}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 66: Cloud Security Trends - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={cloud, protection, eucs, and service}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
