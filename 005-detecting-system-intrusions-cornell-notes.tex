...
\title{\textcolor{Navy}{Chapter 5: Detecting System Intrusions}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 5: Detecting System Intrusions - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={alerts, rules, file, and server}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
