...
% Style: latex-docs-technical-design-spec (which transitively loads
%        latex-docs-technical -> latex-docs-base -> latex-docs-style).
...
% Parent
\node[abs]                                                       (root) {%
  \textbf{latex-docs-base}\\\scriptsize\itshape parent (abstract)};
...
generalise from one parent. Documents never load \Module{latex-docs-base}
directly and never load two sibling modules simultaneously.

% =============================================================================
\section{Parent module responsibilities}

\Module{latex-docs-base.sty} is the abstract root of the hierarchy.
...
tooling/latex/
  ...
  styles/
    ...
    latex-docs-base.sty             # parent / hierarchy root
    latex-docs-legal.sty
    latex-docs-financial.sty
    latex-docs-business-admin.sty
    latex-docs-hr.sty
    latex-docs-personal-official.sty
    latex-docs-technical.sty                   # abstract intermediate
    latex-docs-technical-user-manual.sty
    latex-docs-technical-design-spec.sty
    latex-docs-technical-implementation.sty
    latex-docs-technical-installation.sty
    latex-docs-technical-testing.sty
...
instead of \Cmdline{\textbackslash RequirePackage\{latex-docs-base\}}.
...
\begin{enumerate}
  ...
  \item First non-comment line:
        \Cmdline{\textbackslash RequirePackage\{latex-docs-base\}}.
