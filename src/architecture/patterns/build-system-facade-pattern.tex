...
%--------------------------- Code Listings ---------------------------------
% Minted is the canonical backend; the document uses a simple, self-contained
% setup that works in the current CI environment.
\usepackage[cache=false]{minted}
\setminted{fontsize=\small,breaklines=true,tabsize=2}

% Fallback colors used by the document's checkmark helpers.
\definecolor{successgreen}{HTML}{0B8F3A}
\definecolor{dangerred}{HTML}{B00020}
\renewcommand{\cmark}{\textcolor{successgreen}{\ding{51}}}
\renewcommand{\xmark}{\textcolor{dangerred}{\ding{55}}}
\begin{document}
\maketitle
