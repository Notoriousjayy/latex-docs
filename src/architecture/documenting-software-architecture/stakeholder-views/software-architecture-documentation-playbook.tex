...
\usepackage{tikz}
\makeatletter
\expandafter\let\csname @starttoc@latex@orig\endcsname\@starttoc
\makeatother
...
\chapter[Stakeholders and Their Documentation Needs]{Stakeholders and Their\\Documentation Needs}
...
\chapter[Component-and-Connector Views Overview]{Component-and-Connector\\Views Overview}
...
Shared-data views support understanding data-centric systems such as blackboard architectures and database-centered integration.
...
\chapter[Quick Reference: Style Selection Guide]{Quick Reference: Style\\Selection Guide}
...
\begin{longtable}{|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4cm}|}
\hline
\rowcolor{lightgray}
...
\chapter[Quick Reference: Stakeholder-View Matrix]{Quick Reference: Stakeholder-View\\Matrix}
