...
% Header and footer
% Ensure fancyhdr has enough space for the header
...
% Define YAML language for listings (listings does not ship YAML by default)
...
\begin{tikzpicture}[
    ...
    % Binding annotation
    \node[draw, rounded corners, fill=bindingcolor!20, font=\scriptsize, align=center] at (5,-1) {Binding Time:\\When selection occurs};
\end{tikzpicture}
