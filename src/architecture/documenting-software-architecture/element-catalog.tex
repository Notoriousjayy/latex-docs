...
% Typesetting robustness (helps avoid overfull boxes in narrow columns)
...
% Header and footer
\pagestyle{fancy}
\setlength{\headheight}{14pt}% prevent fancyhdr headheight warning
\addtolength{\topmargin}{-2pt}% compensate for increased headheight
\fancyhf{}
...
% JSON language support for listings (prevents 'Couldn't load requested language')
