...
\begin{tikzpicture}[
    scale=0.7,
    transform shape,
    decision/.style={draw, thick, fill=decisioncolor!25, minimum width=3cm, minimum height=1.2cm, rounded corners=5pt, font=\small\bfseries, align=center},
    driver/.style={draw, thick, fill=drivercolor!25, minimum width=2.2cm, minimum height=0.9cm, rounded corners=3pt, font=\small, align=center},
    alt/.style={draw, thick, fill=alternativecolor!25, minimum width=2cm, minimum height=0.8cm, rounded corners=3pt, font=\scriptsize, align=center},
    consequence/.style={draw, thick, fill=consequencecolor!30, minimum width=2.2cm, minimum height=0.8cm, rounded corners=3pt, font=\scriptsize, align=center},
...
\begin{longtable}{@{}L{2.5cm} C{1.7cm} L{4cm} L{4.5cm}@{}}
...
\begin{longtable}{@{}L{1.3cm} L{3.5cm} L{4cm} L{2.5cm} L{3cm}@{}}
...
\begin{tabular}{@{}L{3cm} C{1.6cm} C{2.1cm} C{2.1cm} C{2.1cm} C{2.1cm}@{}}
\toprule
\textbf{Criterion} & \textbf{Weight} & \textbf{Postgres} & \textbf{MySQL} & \textbf{MongoDB} & \makecell{\textbf{Dynamo}\\\textbf{DB}} \\
\midrule
...
\begin{longtable}{@{}L{1cm} L{3cm} L{2.5cm} L{2cm} L{4.2cm}@{}}
...
\bottomrule
\endlastfoot
\makecell[l]{Deliberate/\\Prudent} & Conscious choice with clear payoff & ``Ship now, refactor before scale'' \\
\makecell[l]{Deliberate/\\Reckless} & Conscious choice ignoring consequences & ``No time for design'' \\
\makecell[l]{Inadvertent/\\Prudent} & Learned better approach after building & ``Now we know how to do it properly'' \\
\makecell[l]{Inadvertent/\\Reckless} & Due to lack of skill or knowledge & ``What's layering?'' \\
\end{longtable}
...
\begin{longtable}{@{}L{1.7cm} L{3cm} L{3cm} L{2.5cm} L{2.2cm}@{}}
...
\begin{longtable}{@{}L{2.7cm} L{5.5cm} L{5cm}@{}}
...
\begin{longtable}{@{}L{1.7cm} L{4cm} L{7cm}@{}}
...
\begin{longtable}{@{}L{1.7cm} L{3cm} L{3cm} L{2cm} L{2.5cm}@{}}
...
\begin{tikzpicture}[
    scale=0.75,
    transform shape,
     procstep/.style={draw, thick, fill=decisioncolor!20, minimum width=2.5cm, minimum height=1cm, rounded corners=3pt, font=\small},
    arrow/.style={-{Stealth[length=2.5mm]}, thick}
]
    % Steps
    \node[procstep] (identify) at (0,0) {1. Identify Need};
    \node[procstep] (research) at (4,0) {2. Research Options};
    \node[procstep] (evaluate) at (8,0) {3. Evaluate Alternatives};
    \node[procstep] (propose) at (0,-2.5) {4. Propose Decision};
    \node[procstep] (review) at (4,-2.5) {5. Review \& Discuss};
    \node[procstep] (decide) at (8,-2.5) {6. Decide};
    \node[procstep] (document) at (2,-5) {7. Document ADR};
    \node[procstep] (implement) at (6,-5) {8. Implement};
...
\toprule
\textbf{ID} & \textbf{Decision Needed} & \textbf{Urgency} & \textbf{Target Date} & \makecell[l]{\textbf{Blocker/}\\\textbf{Dependencies}} \\
\midrule
\endfirsthead
\toprule
\textbf{ID} & \textbf{Decision Needed} & \textbf{Urgency} & \textbf{Target Date} & \makecell[l]{\textbf{Blocker/}\\\textbf{Dependencies}} \\
