...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{02-filter-types}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{09-pipe-types}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{06-execution-models}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{03-linear-pipeline-compiler}
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{07-parallel-pipeline-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.65\textwidth]{04-fork-join-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{05-error-channel-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{08-tee-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{10-unix-pipeline-example}
