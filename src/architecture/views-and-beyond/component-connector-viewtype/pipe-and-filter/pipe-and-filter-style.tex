...
% SVG path configuration - matches workflow output structure
\svgpath{{src/pipe-and-filter/svg/}}
...
\begin{figure}[H]
\centering
\includesvg[width=0.95\textwidth]{svg/01-basic-architecture}
...
\begin{figure}[H]
\centering
\includesvg[width=0.85\textwidth]{svg/02-filter-types}
...
\begin{figure}[H]
\centering
\includesvg[width=0.9\textwidth]{svg/09-pipe-types}
...
\begin{figure}[H]
\centering
\includesvg[width=0.9\textwidth]{svg/06-execution-models}
...
\begin{figure}[H]
\centering
\includesvg[width=0.95\textwidth]{svg/03-linear-pipeline-compiler}
...
\begin{figure}[H]
\centering
\includesvg[width=0.75\textwidth]{svg/07-parallel-pipeline-pattern}
...
\begin{figure}[H]
\centering
\includesvg[width=0.65\textwidth]{svg/04-fork-join-pattern}
...
\begin{figure}[H]
\centering
\includesvg[width=0.9\textwidth]{svg/05-error-channel-pattern}
...
\begin{figure}[H]
\centering
\includesvg[width=0.75\textwidth]{svg/08-tee-pattern}
...
\begin{figure}[H]
\centering
\includesvg[width=0.95\textwidth]{svg/10-unix-pipeline-example}
