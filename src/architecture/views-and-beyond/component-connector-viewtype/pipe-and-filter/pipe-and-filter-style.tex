...
% Diagram path configuration - relative to document directory
% The render-plantuml workflow creates svg/ (and optionally png/) alongside this .tex file
\svgpath{{svg/}}
% Optional raster image paths (if you include non-PlantUML assets)
\graphicspath{{png/}{jpg/}{images/}}
\begin{document}
