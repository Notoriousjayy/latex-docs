% -------------------------------------------------------------------------
% File: src/architecture/views-and-beyond/style-catalogs/allocation/deployment-style/deployment-style.tex
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{deployment-style-software-to-hardware-mapping}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{deployment-view-relationships}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{software-elements-in-deployment-views}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{environmental-elements-the-hosting-platform}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{deployment-relations}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{allocation-binding-types}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{deployment-constraints}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{quality-attributes-affected-deployment}
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{single-node-deployment-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{load-balanced-cluster-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{primary-replica-deployment-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{microservices-on-kubernetes}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{multi-region-deployment-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.9\textwidth]{hybrid-cloud-deployment-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{three-tier-web-application-deployment}
