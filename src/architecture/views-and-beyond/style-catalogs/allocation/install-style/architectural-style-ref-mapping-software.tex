...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{mapping-software-file-systems}
...
\begin{figure}[H]
\centering
\diagram[width=0.90\textwidth]{software-element-types}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{environmental-elements-file-system-structure}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{install-style-relations}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{quality-attributes-affected-installation}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{common-installation-patterns}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{config-hierarchy-pattern-precedence-instance}
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{installation-lifecycle-stages}
