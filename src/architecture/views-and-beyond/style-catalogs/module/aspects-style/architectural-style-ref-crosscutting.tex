% -------------------------------------------------------------------------
% File: src/architecture/views-and-beyond/style-catalogs/module/aspects-style/aspects-style.tex
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{crosscutting-problem-scattering-tangling}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{aspect-solution-modularized-crosscutting}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{anatomy-of-an-aspect-module}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{the-crosscuts-relation-many-to-many}
...
\begin{figure}[H]
\centering
\diagram[width=0.65\textwidth]{aspect-weaving-mechanisms}
...
\begin{figure}[H]
\centering
\diagram[width=0.45\textwidth]{advice-execution-order-at-join-point-sec-high}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{common-aspect-patterns}
