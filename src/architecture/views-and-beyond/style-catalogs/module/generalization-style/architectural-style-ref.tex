% -------------------------------------------------------------------------
% File: src/architecture/views-and-beyond/style-catalogs/module/generalization-style/generalization-style.tex
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{basic-generalization-hierarchy-modules}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{inheritance-vs-composition-two-approaches}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{module-types-generalization-roles-modules}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{types-generalization-relations-four}
...
\begin{figure}[H]
\centering
\diagram[width=0.70\textwidth]{diamond-problem-ambiguity-multiple-impl}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{common-generalization-patterns-design}
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{liskov-substitution-principle-children-must}
...
\begin{figure}[H]
\centering
\diagram[width=0.70\textwidth]{collections-framework-hierarchy-classic}
