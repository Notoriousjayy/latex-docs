% -------------------------------------------------------------------------
% File: src/architecture/views-and-beyond/style-catalogs/module/layered-style/layered-style.tex
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{basic-layered-arch-higher-layers-depend-lower}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{layers-vs-tiers-logical-code-organization-vs}
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{layer-types-abstraction-level-concrete}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{allowed-use-relation-permissions-define-valid}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{strict-vs-relaxed-layering-constraining}
...
\begin{figure}[H]
\centering
\diagram[width=0.75\textwidth]{layering-sidecar-pattern-cross-cutting}
...
\begin{figure}[H]
\centering
\diagram[width=0.7\textwidth]{layering-callback-pattern-lower-layers-invoke}
...
\begin{figure}[H]
\centering
\diagram[width=0.98\textwidth]{common-layered-architectures-compared-three}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{quality-attribute-impact-layering-how-layered}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{web-app-layered-arch-concrete-modules-within}
