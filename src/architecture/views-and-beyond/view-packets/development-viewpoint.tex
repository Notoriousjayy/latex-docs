...
\begin{minted}{text}[caption={Directory Structure Example}, language={}]
project-root/
|-- src/
|   |-- main/
|   |   |-- java/
...
\begin{minted}{text}[caption={Module Specification Template}, language={}]
...
\begin{minted}{text}[caption={Example ArchUnit Test (Java)}, language=Java]
@Test
...
\begin{minted}{text}[caption={Complete Module Specification Template}, language={}]
================================================================================
MODULE SPECIFICATION
================================================================================
