...
% Listings configuration removed; minted is configured by shared style.
...
\begin{minted}[caption={Directory Structure Example}]{{}}
project-root/
|-- src/
|   |-- main/
|   |   |-- java/
...
\begin{minted}[caption={Module Specification Template}]{{}}
...
\begin{minted}[caption={Example ArchUnit Test (Java)}]{Java}
@Test
...
\begin{minted}[caption={Complete Module Specification Template}]{{}}
================================================================================
MODULE SPECIFICATION
================================================================================
