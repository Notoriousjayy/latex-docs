...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{soa-core-elements}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{service-communication-patterns}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{orchestration-vs-choreography}
...
\begin{figure}[H]
\centering
\diagram[width=0.95\textwidth]{service-layer-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.90\textwidth]{api-gateway-pattern}
...
\begin{figure}[H]
\centering
\diagram[width=0.85\textwidth]{service-lifecycle}
