...
\usepackage{booktabs}
\usepackage{xcolor}
\usepackage[protrusion=true,expansion=false]{microtype}% disable font expansion for CI portability
\usepackage{enumitem}
\usepackage{titlesec}
\usepackage{fancyhdr}
\usepackage{tocloft}
...
\textbf{Experiment}:
\begin{itemize}
\item Use chaos engineering to validate resilience\url{https://chaos-mesh.org/docs/}
\item Test failure scenarios regularly
\item Run game day exercises with your team
\end{itemize}
\textbf{Measure}:
\begin{itemize}
\item Implement SLOs and error budgets\url{https://sre.google/sre-book/service-level-objectives/}
