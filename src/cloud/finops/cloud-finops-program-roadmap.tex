...
\begin{tikzpicture}[scale=1.1]
    % Central circle
    \node[circle, draw=primaryblue, fill=primaryblue!10, minimum size=3cm, font=\large\bfseries] (center) at (0,0) {FinOps\\Lifecycle};
...
\begin{tikzpicture}[
    ...
    process/.style={rectangle, rounded corners, draw=secondaryblue, fill=secondaryblue!15, minimum width=2.5cm, minimum height=1cm, font=\small},
    store/.style={cylinder, draw=primaryblue, fill=primaryblue!15, minimum width=2cm, minimum height=1.2cm, font=\small, shape border rotate=90, aspect=0.3},
