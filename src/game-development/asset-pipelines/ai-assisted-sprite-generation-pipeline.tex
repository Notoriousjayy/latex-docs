...
\begin{minted}{text}[language=Python, caption={Automated batch sprite generation}]
#!/usr/bin/env python3
"""
...
\begin{minted}{text}[language=Python, caption={Comprehensive sprite validation}]
from PIL import Image
import numpy as np
...
\begin{minted}{text}[language=bash, caption={LoRA training process}]
...
\begin{minted}{text}[language=bash, caption={Git workflow for sprite assets}]
#!/bin/bash
...
\begin{minted}{text}[language=Python, caption={Tool abstraction for future flexibility}]
...
\begin{minted}{text}[caption={Reusable prompt patterns}]
Character Idle:
