...
\begin{minted}[caption={Automated batch sprite generation}]{Python}
#!/usr/bin/env python3
"""
...
\begin{minted}[caption={Comprehensive sprite validation}]{Python}
from PIL import Image
import numpy as np
...
\begin{minted}[caption={LoRA training process}]{bash}
...
\begin{minted}[caption={Git workflow for sprite assets}]{bash}
#!/bin/bash
...
\begin{minted}[caption={Tool abstraction for future flexibility}]{Python}
...
\begin{minted}[caption={Reusable prompt patterns}]{text}
Character Idle:
