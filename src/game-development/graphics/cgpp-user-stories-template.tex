...
% --- Engine-aware encoding & fonts (PDFTeX vs LuaLaTeX/XeLaTeX) ---
\usepackage{iftex}
\ifPDFTeX
...
\else
  ...
  % Use Latin Modern to match the PDFTeX look closely.
...
\ifPDFTeX\DeclareUnicodeCharacter{2194}{\ensuremath{\leftrightarrow}}\else\newunicodechar{↔}{\ensuremath{\leftrightarrow}}\fi  % ↔
\ifPDFTeX\DeclareUnicodeCharacter{2192}{\ensuremath{\rightarrow}}\else\newunicodechar{→}{\ensuremath{\rightarrow}}\fi       % →
\ifPDFTeX\DeclareUnicodeCharacter{2190}{\ensuremath{\leftarrow}}\else\newunicodechar{←}{\ensuremath{\leftarrow}}\fi        % ←
\ifPDFTeX\DeclareUnicodeCharacter{21D2}{\ensuremath{\Rightarrow}}\else\newunicodechar{⇒}{\ensuremath{\Rightarrow}}\fi       % ⇒
\ifPDFTeX\DeclareUnicodeCharacter{21D4}{\ensuremath{\Leftrightarrow}}\else\newunicodechar{⇔}{\ensuremath{\Leftrightarrow}}\fi   % ⇔
% --- end fixes ---
