...
\newcommand{\CornellDocumentTitle}{CISSP CBK Cornell Notes: Domain 8 -- Software Development Security}
\title{\CornellDocumentTitle}
\author{Arthur Deane and Aaron Kraus}
\date{\today}

\setDocTitle{\CornellDocumentTitle}
\setDocSubtitle{Domain 8: Software Development Security}
...
\setDocDate{\today}
\setDocSummary{Cornell-format study and review notes for Domain 8 of the CISSP CBK reference.}

\setCornellCollection{CISSP CBK Cornell Notes}
\setCornellUnitType{Domain}
\setCornellUnitNumber{8}
\setCornellUnitTitle{Software Development Security}
...
\setCornellSourceRange{pp. 549--624}
...
\section{Maturity, Operations, Change, and Integrated Teams}
\source{pp. 561--571}
\begin{cornell}
...
\section{Security Controls in Development Ecosystems}
\source{pp. 572--590}
\begin{cornell}
...
\section{Assessing Software Security Effectiveness}
\source{pp. 590--598}
\begin{cornell}
...
\section{Security Impact of Acquired Software}
\source{pp. 599--604}
\begin{cornell}
...
\section{Secure Coding, Weaknesses, and Vulnerability Frameworks}
\source{pp. 604--612}
\begin{cornell}
...
\section{Secure Coding Practices and Software-Defined Security}
\source{pp. 618--624}
\begin{cornell}
