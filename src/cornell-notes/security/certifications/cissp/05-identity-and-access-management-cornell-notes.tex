...
\newcommand{\CornellDocumentTitle}{CISSP CBK Cornell Notes: Domain 5 -- Identity and Access Management}
\title{\CornellDocumentTitle}
\author{Arthur Deane and Aaron Kraus}
\date{\today}

\setDocTitle{\CornellDocumentTitle}
\setDocSubtitle{Domain 5: Identity and Access Management}
...
\setDocDate{\today}
\setDocSummary{Cornell-format study and review notes for Domain 5 of the CISSP CBK reference.}

\setCornellCollection{CISSP CBK Cornell Notes}
\setCornellUnitType{Domain}
\setCornellUnitNumber{5}
\setCornellUnitTitle{Identity and Access Management}
...
\setCornellSourceRange{pp. 377--418}
...
\section{Control Physical and Logical Access to Assets}
\source{pp. 378--386}
\begin{cornell}
...
\section{Federated Identity with Third-Party Services}
\source{pp. 401--403}
\begin{cornell}
...
\section{Identity and Access Provisioning Lifecycle}
\source{pp. 408--413}
\begin{cornell}
...
\section{Authentication and Federation Systems}
\source{pp. 414--418}
\begin{cornell}
