...
\setlist[itemize]{leftmargin=1.25em,itemsep=1pt,topsep=2pt}\setlist[enumerate]{leftmargin=1.5em,itemsep=1pt,topsep=2pt}
\renewcommand{\arraystretch}{1.18}
\pagestyle{fancy}\fancyhf{}
\lhead{\small\color{navy}\textbf{CISSP CBK Cornell Notes}}\rhead{\small\color{teal}Domain 2: Asset Security}
...
\vspace*{1.0in}
{\Large THE OFFICIAL (ISC)\textsuperscript{2} CISSP CBK REFERENCE\par}\vspace{0.25in}
{\large Sixth Edition \textbullet\ 2021\par}\vfill
{\Huge\bfseries Cornell Notes\par}\vspace{0.25in}
{\LARGE Domain 2\par}\vspace{0.08in}{\LARGE\bfseries Asset Security\par}\vfill
{\large Arthur Deane and Aaron Kraus\par}\vspace{0.12in}{\normalsize Study and review companion\par}\vspace{0.35in}
{\small Primary source: \textit{The Official (ISC)\textsuperscript{2} CISSP CBK Reference}, Sixth Edition, pp. 97--144.\par}
\end{titlepage}
...
\section{\color{navy}Identify and Classify Information and Assets}
\source{pp. 97--103}
\begin{cornell}
...
\section{\color{navy}Information and Asset Handling Requirements}
\source{pp. 104--107}
\begin{cornell}
...
\section{\color{navy}Provision Resources Securely}
\source{pp. 108--114}
\begin{cornell}
...
\section{\color{navy}Manage the Data Lifecycle}
\source{pp. 115--126}
\begin{cornell}
...
\section{\color{navy}Ensure Appropriate Asset Retention}
\source{pp. 127--130}
\begin{cornell}
...
\section{\color{navy}Data Security Controls and Compliance Requirements}
\source{pp. 131--144}
\begin{cornell}
