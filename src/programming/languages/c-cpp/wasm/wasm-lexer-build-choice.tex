...
A custom HTML template via \texttt{--shell-file} is appropriate when:
...
\begin{itemize}[leftmargin=*, itemsep=0.35em]
  ...
  \item \textbf{Standalone demo / quick harness:} generate \textbf{HTML} (optionally with a custom \texttt{--shell-file} template).
\end{itemize}
