...
% listings macros removed; minted is the canonical backendstyle=codestyle}
...
\begin{minted}{text}[style=bashstyle]
# Ubuntu/Debian
sudo apt-get update
...
\begin{minted}{text}[style=codestyle]
{
    "script": "misra.py",
    "args": [
...
\begin{minted}{text}[style=yamlstyle]
---
...
\begin{minted}{text}[style=cstyle]
/* Problematic code */
#include <stdint.h>
