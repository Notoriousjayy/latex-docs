% -------------------------------------------------------------------------
% File: src/programming/web/frontend/micro-frontends-board-user-stories.tex
...
\title{\textbf{Dynamic Project Management Board — Micro Frontends}\\Tailored User Stories (Card Style)}
\author{}
\date{\today}
