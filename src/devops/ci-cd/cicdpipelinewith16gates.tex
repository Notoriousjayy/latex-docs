...
%--- optional shared macros (repo-local); keep document buildable when file is absent
% (loaded earlier)

%--- fallback: safe includegraphics wrapper (used throughout this document)
\providecommand{\safeincludegraphics}[2][]{%
  \IfFileExists{#2}{%
    ...
    \fbox{\parbox[c][0.25\textheight][c]{0.9\linewidth}{\centering\textbf{Missing image}\\\texttt{#2}}}%
    \endgroup
  }%
}
...
\begin{figure}[H]
  \centering
  \safeincludegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{Software Development Pipeline Flow Chart.png}
...
\begin{figure}[H]
  \centering
  \safeincludegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{Infrastructure Provisioning and Release Flow.png}
...
\begin{figure}[H]
  ...
  \safeincludegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{End-to-End CICD Pipeline Flow.png}
