...
\title{\textbf{GitOps Stack Blueprint: Reference Architecture}}
\author{}
\date{}
...
\filename{platform/ansible/playbooks/bootstrap.yaml}\par
\begin{minted}{yaml}
- hosts: workers
  become: true
  roles:
...
\filename{apps/appset/apps.yaml}\par
\begin{minted}{yaml}
...
\filename{apps/sample-web/k8s/ingress.yaml}\par
\begin{minted}{yaml}
...
\filename{platform/gatekeeper/templates/k8spsp-privileged.yaml}\par
\begin{minted}{yaml}
...
\filename{infra/policies/cloudcustodian/enforce-bucket-encryption.yml}\par
\begin{minted}{yaml}
policies:
...
\filename{.github/workflows/ci.yml}\par
\begin{minted}{yaml}
name: ci
on: [push]
