...
\begin{minted}{text}[style=code,language=bash,caption={Top-level repository structure}]
infra/
...
\begin{minted}{text}[style=code,language=hcl,caption={infra/terraform/main.tf}]
...
\begin{minted}{text}[style=code,language=yaml,caption={platform/ansible/playbooks/bootstrap.yaml}]
- hosts: workers
  become: true
  roles:
    - docker
...
\begin{minted}{text}[style=code,language=yaml,caption={apps/appset/apps.yaml}]
...
\begin{minted}{text}[style=code,language=yaml,caption={apps/sample-web/k8s/ingress.yaml}]
...
\begin{minted}{text}[style=code,language=yaml,caption={platform/gatekeeper/templates/k8spsp-privileged.yaml}]
...
\begin{minted}{text}[style=code,language=yaml,caption={infra/policies/cloudcustodian/enforce-bucket-encryption.yml}]
policies:
...
\begin{minted}{text}[style=code,language=yaml,caption={.github/workflows/ci.yml}]
name: ci
on: [push]
