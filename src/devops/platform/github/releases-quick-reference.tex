...
\vfill
\begin{tcolorbox}
\textbf{Build tip.} If you see minted errors about Pygments output, compile with \file{latexmk -pdf -shell-escape}. Avoid using \key{frozencache} unless the cache has been generated on the same machine.
\end{tcolorbox}
