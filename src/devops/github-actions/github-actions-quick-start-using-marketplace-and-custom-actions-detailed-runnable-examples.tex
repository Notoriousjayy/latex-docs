...
\else
  ...
  % minted environments are used directly in this document{% listings macros removed; minted is the canonical backend}}{}

  \NewDocumentCommand{\inputminted}{ O{} m m }{\inputminted{#3}}
  ...
  \NewDocumentCommand{\newminted}{ O{} m m }{%
    ...
    \fi
    % minted environments are used directly in this document\expandafter{\minted@envname}[1][]%
      {% listings macros removed; minted is the canonical backend}}{}%
  }
  \NewDocumentCommand{\newmintedfile}{ O{} m m }{%
...
\begin{itemize}
  ...
  \item \textbf{Frozencache/sty errors}: avoid \texttt{} unless you manage pygstyles; compile with \texttt{-shell-escape}.
