...
\begin{itemize}
  ...
  \item \textbf{Minted \& Pygments cache=false errors}: Build with \texttt{-shell-escape}; avoid \texttt{cache=false} unless the styles exist; run \texttt{latexmk} without \texttt{outputdir} or configure \texttt{minted} accordingly.
