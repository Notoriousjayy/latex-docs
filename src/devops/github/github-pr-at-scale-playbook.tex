...
% Global listings defaults (avoid overfull boxes on long lines)
\lstset{breaklines=true, breakatwhitespace=true, columns=fullflexible}
\usepackage{fancyhdr}

% Header height fix for fancyhdr
...
% CUSTOM COMMANDS
% ============================================================================
\newcommand{\cmark}{\textbf{\color{green!60!black}\ding{51}}}
\newcommand{\xmark}{\textbf{\color{red!70!black}\ding{55}}}
\newcommand{\warnmark}{\textbf{\color{red!70!black}\ding{115}}}
\newcommand{\keypoint}[1]{\textbf{\color{blue!70!black}#1}}
\newcommand{\warning}[1]{\textbf{\color{red!70!black}\warnmark #1}}
\newcommand{\best}[1]{\textbf{\color{green!60!black}\cmark #1}}
...
% BEGIN DOCUMENT
% ============================================================================
% Improve justification to reduce underfull/overfull boxes
\setlength{\emergencystretch}{3em}

% Reduce log noise from underfull boxes in narrow table columns
\hbadness=10000
\hfuzz=2pt
\vfuzz=2pt
...
\begin{itemize}[leftmargin=*]
    \item PR 1 ($\rightarrow$ main): Add database tables (50 LOC)
    \item PR 2 ($\rightarrow$ PR 1): Add repository layer (100 LOC)
    \item PR 3 ($\rightarrow$ PR 2): Add service layer (150 LOC)
    \item PR 4 ($\rightarrow$ PR 3): Add API endpoints (120 LOC)
\end{itemize}
...
\toprule
\textbf{\xmark Avoid} & \textbf{\cmark Prefer} \\
\midrule
...
- **Ask questions rather than making demands**
  - \cmark "Could we consider using X here because Y?"
  - \xmark "This is wrong, use X instead"
        ...
        with:
          script: |
            github.rest.issues.createComment({
              ...
              body: '[WARNING] This is a **major version update**. Please review changelog and test thoroughly before merging.'
            })
\end{lstlisting}
