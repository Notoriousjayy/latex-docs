...
% Ensure head height accommodates fancyhdr
...
% Code listings
% listings: YAML + JSON language definitions (listings doesn't ship these by default)
...
\lstdefinelanguage{json}{%
  ...
  alsoletter={:,},%
  % lightweight highlighting; intended for readability, not strict parsing
  literate=%
