...
\begin{minted}{text}[language=html,caption={Password ``masked'' in UI but fully exposed in DOM}]
...
\begin{minted}{text}[language=http,caption={Identifying user ID in URL parameter}]
...
\begin{minted}{text}[language=bash,caption={Searching for password values in response}]
...
\begin{minted}{text}[language=html,caption={What vulnerable password field looks like in Elements tab}]
...
\begin{minted}{text}[language=http,caption={Testing IDOR by changing user ID}]
...
\begin{minted}{text}[language=http,caption={Step 1: Login with provided credentials}]
...
\begin{minted}{text}[language=http,caption={Step 2: Observe password disclosure on own account}]
GET /my-account?id=wiener HTTP/1.1
Host: 0aXXXXXXXX.web-security-academy.net
...
\begin{minted}{text}[language=http,caption={Step 3: Change id parameter to administrator}]
...
\begin{minted}{text}[language=html]
<input type="password" name="password" value="xK7mN9pQrS2t">
\end{minted}
...
\begin{minted}{text}[language=http,caption={Step 5: Login as administrator}]
...
\begin{minted}{text}[language=http,caption={Step 6: Access admin panel and delete user}]
-- Access admin panel --
GET /admin HTTP/1.1
Host: 0aXXXXXXXX.web-security-academy.net
Cookie: session=adminSession789
...
\begin{minted}{text}[language=python,caption={Full multi-phase exploitation script}]
#!/usr/bin/env python3
"""
...
\begin{minted}{text}[language=python,caption={Simplified single-purpose script}]
#!/usr/bin/env python3
...
\begin{minted}{text}[language=bash,caption={Command-line exploitation with curl}]
#!/bin/bash
...
\begin{minted}{text}[caption={Vulnerability report template}]
...
\begin{minted}{text}[language=javascript,caption={Node.js: Proper password storage and change flow}]
...
\begin{minted}{text}[language=javascript,caption={Node.js: Derive user from session, not parameter}]
...
\begin{minted}{text}[language=python,caption={Django: Secure account view}]
...
\begin{minted}{text}[language=html,caption={Secure password change form template}]
