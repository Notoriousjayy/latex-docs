...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{bac-request-evaluation-flow.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{bac-idor-vulnerability-and-fix.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{bac-testing-methodology-flow.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{bac-architecture-centralized-authorization.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{bac-rbac-policy-model.png}
