% -------------------------------------------------------------------------
% File: src/security/github-advanced-security/references/ghas-cheatsheet.tex
...
\renewcommand{\kbd}[1]{\colorbox{black!10}{\texttt{#1}}}
...
\begin{ghascallout}[What GHAS Gives You]
\begin{multicols}{2}
\begin{itemize}
...
\begin{ghascallout}[Minimum Safe Defaults]
\begin{itemize}
...
\begin{ghascallout}[Merge Gates Checklist]
\begin{multicols}{2}
\begin{itemize}
