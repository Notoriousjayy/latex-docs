...
\begin{minted}{text}[style=endpoint]
...
\begin{minted}{text}[language=Python,caption={review\_dismissal\_requests.py (reference implementation)}]
#!/usr/bin/env python3
...
\begin{minted}{text}[language=yaml,caption={.github/workflows/review-ghas-dismissals.yml (repo-scoped)}]
...
\begin{minted}{text}[language=yaml,caption={.github/workflows/review-ghas-dismissals-org.yml (org-wide)}]
