...
\newcommand{\ChapterMark}{Chapter 85}
\title{\textcolor{Navy}{Chapter 85: Energy Infrastructure Cyber Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 85: Energy Infrastructure Cyber Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={energy, act, national, and cyber}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
