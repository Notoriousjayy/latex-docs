...
\newcommand{\ChapterMark}{Chapter 48}
\title{\textcolor{Navy}{Chapter 48: Satellite Encryption}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 48: Satellite Encryption - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={satellite, encryption, message, and encrypted}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
