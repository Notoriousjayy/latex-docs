...
\newcommand{\ChapterMark}{Chapter 35}
\title{\textcolor{Navy}{Chapter 35: Risk Management}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 35: Risk Management - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={risk, management, organization, and process}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
