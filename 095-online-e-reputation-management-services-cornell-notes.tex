...
\newcommand{\ChapterMark}{Chapter 95}
\title{\textcolor{Navy}{Chapter 95: Online e-Reputation Management Services}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 95: Online e-Reputation Management Services - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={reputation, decentralized, feedback, and online}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
