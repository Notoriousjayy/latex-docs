...
\newcommand{\ChapterMark}{Chapter 22}
\title{\textcolor{Navy}{Chapter 22: Optical Network Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 22: Optical Network Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={light, optical, access, and fiber}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
