...
\title{\textcolor{Navy}{Chapter 8: Guarding Against Network Intrusions}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 8: Guarding Against Network Intrusions - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={attacks, host, malware, and malicious}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
