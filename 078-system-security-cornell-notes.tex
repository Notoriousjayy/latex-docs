...
\newcommand{\ChapterMark}{Chapter 78}
\title{\textcolor{Navy}{Chapter 78: System Security}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 78: System Security - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={hardware, patch, management, and need}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
