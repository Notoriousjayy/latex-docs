...
\newcommand{\ChapterMark}{Chapter 37}
\title{\textcolor{Navy}{Chapter 37: Disaster Recovery}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 37: Disaster Recovery - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={business, disaster, time, and recovery}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
