...
\title{\textcolor{Navy}{Chapter 6: Intrusion Detection in Contemporary Environments}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 6: Intrusion Detection in Contemporary Environments - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={cloud, malware, mobile, and computing}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
