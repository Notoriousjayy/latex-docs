...
\newcommand{\ChapterMark}{Chapter 56}
\title{\textcolor{Navy}{Chapter 56: Detection of Conflicts in Security Policies}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 56: Detection of Conflicts in Security Policies - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={policy, rules, conflicts, and policies}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
