...
\newcommand{\ChapterMark}{Chapter 53}
\title{\textcolor{Navy}{Chapter 53: Online Privacy}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 53: Online Privacy - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={privacy, user, advertising, and cookies}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
