...
\newcommand{\ChapterMark}{Chapter 93}
\title{\textcolor{Navy}{Chapter 93: An Overview of Cyber Attacks and Defenses on Intelligent Connected Vehicles}\\[2mm]\large Cornell Notes}
\author{}
\date{}
\hypersetup{pdftitle={Chapter 93: An Overview of Cyber Attacks and Defenses on Intelligent Connected Vehicles - Cornell Notes},pdfauthor={},pdfsubject={Cybersecurity study notes},pdfkeywords={avs, attacks, communication, and ota}}
\begin{document}
\maketitle
\thispagestyle{fancy}
\vspace{-1.5em}
